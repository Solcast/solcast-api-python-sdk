...
def radiation_and_weather(
    ...
    client = ClientWithPandas(
        base_url=base_url, endpoint=forecast_radiation_and_weather
    )
...
def rooftop_pv_power(
    ...
    See https://docs.solcast.com.au/ for full list of parameters.
    """
    client = ClientWithPandas(base_url=base_url, endpoint=forecast_rooftop_pv_power)
...
def advanced_pv_power(resource_id: int, **kwargs) -> ResponseWithPandas:
    ...
    See https://docs.solcast.com.au/ for full list of parameters.
    """
    client = ClientWithPandas(base_url=base_url, endpoint=forecast_advanced_pv_power)
